...
SCOPES_LIBEXPORT const sc_type_t *sc_typename_type(const sc_string_t *str);
SCOPES_LIBEXPORT sc_void_raises_t sc_typename_type_set_super(const sc_type_t *T, const sc_type_t *ST);
