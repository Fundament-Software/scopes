...
//SCOPES_LIBEXPORT sc_string_raises_t sc_compile_wasm_to_buffer(const sc_string_t *module_name, int file_kind, const sc_scope_t *table, uint64_t flags);
SCOPES_LIBEXPORT sc_string_raises_t sc_compile_to_buffer(const sc_string_t *target_triple, const sc_string_t *module_name, int file_kind, const sc_scope_t *table, uint64_t flags);
