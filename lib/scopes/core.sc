...
spice-quote
    ...
    inline compile-object-to-buffer (target file-kind module-name table flags...)
        sc_compile_object_to_buffer target file-kind module-name table (parse-compile-flags flags...)
...
type+ i32
    let MIN = -2147483648:i32
    let MAX = 2147483647:i32

type+ u32
    let MIN = 0:u32
    let MAX = 4294967295:u32

type+ i64
    let MIN = -9223372036854775808:i64
    let MAX = 9223372036854775807:u64

type+ u64
    let MIN = 0:u64
    let MAX = 18446744073709551615:u64
